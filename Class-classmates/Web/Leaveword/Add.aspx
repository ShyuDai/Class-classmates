<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="Maticsoft.Web.Leaveword.Add" Title="增加页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:DropDownList ID="ddlFk_News_Id" runat="server" DataSourceID="ObjectDataSource1" DataTextField="Name" DataValueField="Id"></asp:DropDownList>
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtFK_Users_Id" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		留言时间
