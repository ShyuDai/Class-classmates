<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LeavewordList.aspx.cs" Inherits="Maticsoft.Web.LeavewordList" %>
    ...
    <dl class="p2">
      <dd>
        <ul class="b3">
          ...
          <ItemTemplate>
          <li><a href="LeaveWords.aspx?id=<%#Eval("Id").ToString()%>"><%#Eval("Name").ToString()%></a><small>(<%#Convert.ToDateTime(Eval("AddTime")).ToString("yyyy-MM-dd")%>)</small></li>
          </ItemTemplate>
          </asp:Repeater> 
          <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                SelectMethod="GetAllList" TypeName="Maticsoft.BLL.Leaveword">
