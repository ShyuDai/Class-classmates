...
<ControlStyle Width="30px"></ControlStyle>
		                ...
		                <asp:TemplateField HeaderText="新闻标题" SortExpression="Name">
                            <EditItemTemplate>
		...
		<ItemTemplate>
			<asp:Label ID="lblFk_NewsType_Id" runat="server" Text='<%#Eval("Fk_NewsType_Id") %>'  Visible="false"></asp:Label>
			<asp:Repeater ID="rptFk_NewsType_Id" runat="server" DataSourceID="odsFk_NewsType_Id"><ItemTemplate><%#Eval("Name") %></ItemTemplate></asp:Repeater>
			<asp:ObjectDataSource ID="odsFk_NewsType_Id" runat="server" SelectMethod="GetModel" TypeName="Maticsoft.BLL.NewsType"><SelectParameters><asp:ControlParameter ControlID="lblFk_NewsType_Id" Name="Id" PropertyName="Text" Type="Int32" /></SelectParameters></asp:ObjectDataSource>
		</ItemTemplate>
		</asp:TemplateField>
		...
		<asp:TemplateField HeaderText="发布用户">
		<ItemTemplate>
